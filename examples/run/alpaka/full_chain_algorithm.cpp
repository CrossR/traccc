...
full_chain_algorithm::full_chain_algorithm(
    ...
    : messaging(logger->clone()),
      ...
      m_seeding(finder_config, grid_config, filter_config,
                ...
                m_queue, logger->cloneWithSuffix("SeedingAlg")),
      m_track_parameter_estimation(
          memory_resource{*m_cached_device_mr, &m_host_mr}, m_copy, m_queue,
          logger->cloneWithSuffix("TrackParamEstAlg")),
      m_finding(finding_config,
                memory_resource{*m_cached_device_mr, &m_host_mr}, m_copy,
                m_queue, logger->cloneWithSuffix("TrackFindingAlg")),
      m_fitting(fitting_config,
                memory_resource{*m_cached_device_mr, &m_host_mr}, m_copy,
                m_queue, logger->cloneWithSuffix("TrackFittingAlg")),
