...
void sort(queue &q, const traccc::memory_resource mr,
...
template <typename ForwardIt1, typename ForwardIt2, typename OutputIt,
          typename Compare>
void upper_bound(queue &q, const traccc::memory_resource &mr, ForwardIt1 first1,
...
OutputIt unique_copy(queue &q, const traccc::memory_resource &mr, InputIt first,
